/* Template Factory - Felling Electric live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-felling-corona/';
  var LS_CHANGES = 'tf_felling_change_log_v1';
  var LS_PURCHASED = 'tf_felling_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Residential electrical, panel upgrades, and wiring across Corona and the Inland Empire. You get a fixed itemised quote before we start, Weston as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Weston at Felling Electric. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Weston Avery Felling at Felling Electric. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Felling Electric. Hang tight.',
        delay,
        function () {
